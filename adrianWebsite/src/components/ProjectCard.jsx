...
const ProjectCard = ({ title, image, description, websiteLink, ...props }) => {
    return (
        <div className='flex flex-col bg-gray-400 shadow-sm rounded-lg p-4 w-full max-w-md mx-auto border border-black' {...props}>
            ...
            {websiteLink && (<a href={websiteLink} target='_blank' rel='noopener noreferrer' className='text-center font-semibold hover:underline '>Website Link</a>)}
        </div>
    );
};
